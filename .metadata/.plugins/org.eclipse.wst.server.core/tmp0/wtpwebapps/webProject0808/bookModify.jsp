...
<link rel="stylesheet" href="./css/bookModify.css" />
<script src="./js/bookModify.js" defer></script>
<script src="./js/bookDelete.js" defer></script>
</head>
<body>
<%@ include file="./jsp_common/header.jsp" %>
<%@ include file="./jsp_container/bookModifyCon.jsp" %>
