...
public class MemberDAO {
	...
	public ArrayList<Member_p01> selectPageMembersDo(int page) {
		...
		try {
			...
			query = "select * from( " + 
					...
					"select userid, userpw, username, email, joindate from member_p01 order by userid asc " + 
	...
	public int getTotalNumForSearch(String category, String searching) {
		...
		PreparedStatement pstm = null;
		ResultSet rs = null;
		String query = "select count(*) from member_p01 where " + category + " like ?";
	...
	public ArrayList<Member_p01> selectPageMembersForSearchDo(String category, String searching, int page) {
		ArrayList<Member_p01> members = new ArrayList<Member_p01>();
